...
public class ActivityRistorante extends Activity {
    ...
    public ActivityRistorante(User user, Ristorante ristorante, String type) {
        this();
        setUser(user);
    ...
    public ActivityRistorante(Timestamp date, User user, Ristorante ristorante, String type) {
        setDate(date);
        setUser(user);
        this.ristorante = ristorante;
        this.type = type;
