...
public class ActivityRistoranteServiceTest {
    ...
    public void setUp() throws JackWicketException {
        ...
        Collection<UserRelation> friends = userRelationService.getAllFollowUsers(user);
    ...
    public void tearDown() {
        try {
            ...
            List<UserRelation> friends = new ArrayList<UserRelation>(userRelationService.getAllFollowUsers(user));
