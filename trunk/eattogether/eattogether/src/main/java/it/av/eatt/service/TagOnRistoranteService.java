...
public interface TagOnRistoranteService {
     ...
     * @throws JackWicketException
     */
    TagOnRistorante insert(String tag, Ristorante ristorante) throws JackWicketException;
    ...
    /**
     * Return all the tags on the given restaurant
     *
     * @param risto
     *
     * @return List<TagOnRistorante>
     */
    @Transactional(readOnly = true)
    List<TagOnRistorante> getAllByRistorante(Ristorante risto) throws JackWicketException;
