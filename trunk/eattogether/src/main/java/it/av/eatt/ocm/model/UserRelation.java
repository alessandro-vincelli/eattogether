...
public class UserRelation extends BasicEntity{
    ...
    public static UserRelation createFollowRelation(User fromUser, User toUser){
    ...
    public static UserRelation createFriendRelation(User fromUser, User toUser){
        UserRelation relation = new UserRelation();
        relation.setStartDate(new Timestamp(Calendar.getInstance().getTimeInMillis()));
